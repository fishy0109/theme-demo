 ...
 * @ingroup GA_Login
 */
class GALoginTotpSetupPluginTest extends TfaTestBase {
   ...
   *
   * @var \Drupal\ga_login\Plugin\TfaSetup\GALoginTotpSetup
   */
  public $setupPlugin;
  ...
  public function testPluginSetup() {
    ...
    // Save recovery codes.
    // @todo - remove when fallbacks are removed.
    $assert->pageTextContains('Your recovery codes');
